...
Download Fedora 20 Minimal, the u-boot images, and kernel
    ...
    wget http://people.redhat.com/jmontleo/cubox-i4pro/rpms/stable/armhfp/kernel-3.14.6-200.cubox_i4pro.fc20.armv7hl.rpm 
...
Write everything to the media, and perform some additional setup
    ...
    rpm -i --noscripts --ignorearch --root /mnt/f20cuboxi4root ./kernel-3.14.6-200.cubox_i4pro.fc20.armv7hl.rpm
    ln -sf uEnv.txt-3.14.6-200.cubox_i4pro.fc20.armv7hl /mnt/f20cuboxi4root/boot/uEnv.txt
...
You can build using the SRPM:
    ...
    yumdownloader --source kernel-3.14.6-200.cubox_i4pro.fc20
    yum-builddep -y kernel-3.14.6-200.cubox_i4pro.fc20.src.rpm
    rpm -ivh  kernel-3.14.6-200.cubox_i4pro.fc20.src.rpm
