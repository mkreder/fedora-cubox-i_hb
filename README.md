...
Download the image
    ...
    wget https://googledrive.com/host/0B0vm64JM4bFZZEVVRE5IZlAyX2M -O Fedora-Minimal-armhfp-cubox-i_hb-20-1-sda.raw.xz
...
Download Fedora 20 Minimal, the u-boot images, and kernel
    ...
    wget http://people.redhat.com/jmontleo/cubox-i_hb/rpms/stable/armhfp/kernel-3.15.4-200.cuboxi_hb.fc20.armv7hl.rpm 
...
Write everything to the media, and perform some additional setup
    ...
    rpm -i --noscripts --ignorearch --root /mnt/f20cuboxi4root ./kernel-3.15.4-200.cuboxi_hb.fc20.armv7hl.rpm
    ln -sf uEnv.txt-3.15.4-200.cuboxi_hb.fc20.armv7hl /mnt/f20cuboxi4root/boot/uEnv.txt
...
After first boot kernel modules probably won't load. The easiest way to fix this is to run:
    ...
    rpm -ivh --force http://people.redhat.com/jmontleo/cubox-i_hb/rpms/stable/armhfp/kernel-3.15.4-200.cuboxi_hb.fc20.armv7hl.rpm
    
To get blueooth support set up:

    yum -y install cubox-i_hb-brcm4329-bluetooth 
    systemctl enable brcm4329-bluetooth
    systemctl start brcm4329-bluetooth
...
You can build using the SRPM:
    ...
    yumdownloader --source kernel-3.15.4-200.cuboxi_hb.fc20
    yum-builddep -y kernel-3.15.4-200.cuboxi_hb.fc20.src.rpm
    rpm -ivh  kernel-3.15.4-200.cuboxi_hb.fc20.src.rpm
